...
import (
	...
	"github.com/ArmandoOC/interfacesandgoroutines/goroutinesadvancedmore/data"
)
...
//La diferencia de este programa vs la carpeta goroutinesadvanced
//está en el uso de mutex específicos para lectura y otros específicos
//para escritura
